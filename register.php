...
<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST")
  {
   $input_username = trim($_POST["username"]);
    ...
    {
      $name_err = "Username can only contain letters, numbers, and underscore.";
    }
    else
    {
    ...
    {
      $confirm_password_err = "Please input a password confirmation.";
    }
    else
    {
        ...
        <div class="col-md-6 offset-md-3">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="confirm_password" name="confirm_password" class="form-control <?php echo(!empty($confirm_password_err)) ? 'is-invalid':''?>" value="<?= $confirm_password ?>">
